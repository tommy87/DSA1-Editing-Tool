...
namespace DSA_1_Editing_Tool
{
    static class CFarbPalette
    {
        ...
        static Color[] defaultPalette = null;
...
Z.B. sind die Gesichter der Helden 0x20-0x3f, die Gegenstände 0x40-0x5f. Bei diesen speziellen Bereichen gibt es feste Paletten die für alle Bilder eines Typs gelten.*/
        ...
        static private void initTownPalette()
        {
            if (townPalette == null)
            {
                townPalette = new Color[64];

                townPalette[0] = Color.FromArgb(0x00 * 4, 0x00 * 4, 0x00 * 4);
                townPalette[1] = Color.FromArgb(0x39 * 4, 0x39 * 4, 0x39 * 4);
                townPalette[2] = Color.FromArgb(0x32 * 4, 0x32 * 4, 0x32 * 4);
                townPalette[3] = Color.FromArgb(0x2C * 4, 0x2C * 4, 0x2C * 4);
                townPalette[4] = Color.FromArgb(0x26 * 4, 0x26 * 4, 0x26 * 4);
                townPalette[5] = Color.FromArgb(0x20 * 4, 0x20 * 4, 0x20 * 4);
                townPalette[6] = Color.FromArgb(0x1A * 4, 0x1A * 4, 0x1A * 4);
                townPalette[7] = Color.FromArgb(0x13 * 4, 0x13 * 4, 0x13 * 4);

                townPalette[8] = Color.FromArgb(0x0D * 4, 0x0D * 4, 0x0D * 4);
                townPalette[9] = Color.FromArgb(0x37 * 4, 0x30 * 4, 0x2C * 4);
                townPalette[10] = Color.FromArgb(0x32 * 4, 0x29 * 4, 0x25 * 4);
                townPalette[11] = Color.FromArgb(0x2D * 4, 0x23 * 4, 0x1F * 4);
                townPalette[12] = Color.FromArgb(0x28 * 4, 0x1D * 4, 0x1A * 4);
                townPalette[13] = Color.FromArgb(0x22 * 4, 0x17 * 4, 0x15 * 4);
                townPalette[14] = Color.FromArgb(0x1E * 4, 0x12 * 4, 0x11 * 4);
                townPalette[15] = Color.FromArgb(0x18 * 4, 0x0D * 4, 0x0D * 4);

                townPalette[16] = Color.FromArgb(0x17 * 4, 0x09 * 4, 0x09 * 4);
                townPalette[17] = Color.FromArgb(0x21 * 4, 0x0D * 4, 0x0B * 4);
                townPalette[18] = Color.FromArgb(0x2C * 4, 0x11 * 4, 0x0D * 4);
                townPalette[19] = Color.FromArgb(0x37 * 4, 0x16 * 4, 0x0D * 4);
                townPalette[20] = Color.FromArgb(0x2A * 4, 0x2C * 4, 0x1C * 4);
                townPalette[21] = Color.FromArgb(0x20 * 4, 0x25 * 4, 0x14 * 4);
                townPalette[22] = Color.FromArgb(0x17 * 4, 0x1E * 4, 0x0E * 4);
                townPalette[23] = Color.FromArgb(0x0F * 4, 0x17 * 4, 0x09 * 4);

                townPalette[24] = Color.FromArgb(0x08 * 4, 0x10 * 4, 0x05 * 4);
                townPalette[25] = Color.FromArgb(0x32 * 4, 0x25 * 4, 0x03 * 4);
                townPalette[26] = Color.FromArgb(0x29 * 4, 0x1E * 4, 0x02 * 4);
                townPalette[27] = Color.FromArgb(0x20 * 4, 0x17 * 4, 0x02 * 4);
                townPalette[28] = Color.FromArgb(0x04 * 4, 0x0F * 4, 0x18 * 4);
                townPalette[29] = Color.FromArgb(0x05 * 4, 0x14 * 4, 0x1F * 4);
                townPalette[30] = Color.FromArgb(0x05 * 4, 0x1A * 4, 0x26 * 4);
                townPalette[31] = Color.FromArgb(0x06 * 4, 0x1F * 4, 0x2D * 4);

                //--------------------32-----------------
                townPalette[32] = Color.FromArgb(0x00 * 4, 0x00 * 4, 0x00 * 4);
                townPalette[33] = Color.FromArgb(0x05 * 4, 0x0D * 4, 0x28 * 4);
                townPalette[34] = Color.FromArgb(0x06 * 4, 0x10 * 4, 0x32 * 4);
                townPalette[35] = Color.FromArgb(0x3F * 4, 0x00 * 4, 0x3F * 4);
                townPalette[36] = Color.FromArgb(0x3F * 4, 0x00 * 4, 0x3F * 4);
                townPalette[37] = Color.FromArgb(0x2D * 4, 0x2D * 4, 0x38 * 4);
                townPalette[38] = Color.FromArgb(0x29 * 4, 0x29 * 4, 0x36 * 4);
                townPalette[39] = Color.FromArgb(0x26 * 4, 0x26 * 4, 0x34 * 4);

                townPalette[40] = Color.FromArgb(0x23 * 4, 0x23 * 4, 0x32 * 4);
                townPalette[41] = Color.FromArgb(0x21 * 4, 0x20 * 4, 0x31 * 4);
                townPalette[42] = Color.FromArgb(0x1F * 4, 0x1E * 4, 0x1F * 4);
                townPalette[43] = Color.FromArgb(0x1C * 4, 0x1B * 4, 0x2D * 4);
                townPalette[44] = Color.FromArgb(0x1A * 4, 0x19 * 4, 0x2C * 4);
                townPalette[45] = Color.FromArgb(0x19 * 4, 0x16 * 4, 0x2A * 4);
                townPalette[46] = Color.FromArgb(0x16 * 4, 0x14 * 4, 0x28 * 4);
                townPalette[47] = Color.FromArgb(0x15 * 4, 0x12 * 4, 0x27 * 4);

                townPalette[48] = Color.FromArgb(0x13 * 4, 0x10 * 4, 0x25 * 4);
                townPalette[49] = Color.FromArgb(0x11 * 4, 0x0E * 4, 0x22 * 4);
                townPalette[50] = Color.FromArgb(0x10 * 4, 0x0C * 4, 0x20 * 4);
                townPalette[51] = Color.FromArgb(0x0E * 4, 0x0B * 4, 0x1E * 4);
                townPalette[52] = Color.FromArgb(0x0E * 4, 0x09 * 4, 0x1B * 4);
                townPalette[53] = Color.FromArgb(0x0C * 4, 0x08 * 4, 0x19 * 4);
                townPalette[54] = Color.FromArgb(0x0B * 4, 0x06 * 4, 0x16 * 4);
                townPalette[55] = Color.FromArgb(0x3F * 4, 0x30 * 4, 0x3F * 4);

                townPalette[56] = Color.FromArgb(0x3F * 4, 0x30 * 4, 0x3F * 4);
                townPalette[57] = Color.FromArgb(0x3F * 4, 0x30 * 4, 0x3F * 4);
                townPalette[58] = Color.FromArgb(0x3F * 4, 0x30 * 4, 0x3F * 4);
                townPalette[59] = Color.FromArgb(0x3F * 4, 0x30 * 4, 0x3F * 4);
                townPalette[60] = Color.FromArgb(0x34 * 4, 0x30 * 4, 0x3A * 4);
                townPalette[61] = Color.FromArgb(0x3C * 4, 0x36 * 4, 0x3C * 4);
                townPalette[62] = Color.FromArgb(0x3F * 4, 0x3C * 4, 0x3C * 4);
                townPalette[63] = Color.FromArgb(0x3F * 4, 0x3F * 4, 0x3F * 4);
            }
        }
        static private void initItemPalette()
        {
            if (itemPalette == null)
            {
                ...
                itemPalette[0] = Color.FromArgb(00 * 4, 00 * 4, 00 * 4);
                itemPalette[1] = Color.FromArgb(56 * 4, 48 * 4, 40 * 4);
                itemPalette[2] = Color.FromArgb(48 * 4, 36 * 4, 28 * 4);
                itemPalette[3] = Color.FromArgb(36 * 4, 24 * 4, 16 * 4);
                itemPalette[4] = Color.FromArgb(32 * 4, 20 * 4, 12 * 4);
                itemPalette[5] = Color.FromArgb(24 * 4, 12 * 4, 08 * 4);
                itemPalette[6] = Color.FromArgb(20 * 4, 08 * 4, 04 * 4);
                itemPalette[7] = Color.FromArgb(12 * 4, 04 * 4, 00 * 4);

                itemPalette[8] = Color.FromArgb(60 * 4, 56 * 4, 00 * 4);
                itemPalette[9] = Color.FromArgb(25 * 4, 40 * 4, 00 * 4);
                itemPalette[10] = Color.FromArgb(48 * 4, 28 * 4, 00 * 4);
                itemPalette[11] = Color.FromArgb(44 * 4, 20 * 4, 00 * 4);
                itemPalette[12] = Color.FromArgb(60 * 4, 36 * 4, 00 * 4);
                itemPalette[13] = Color.FromArgb(60 * 4, 12 * 4, 00 * 4);
                itemPalette[14] = Color.FromArgb(60 * 4, 00 * 4, 08 * 4);
                itemPalette[15] = Color.FromArgb(60 * 4, 00 * 4, 32 * 4);

                itemPalette[16] = Color.FromArgb(00 * 4, 16 * 4, 00 * 4);
                itemPalette[17] = Color.FromArgb(00 * 4, 20 * 4, 00 * 4);
                itemPalette[18] = Color.FromArgb(00 * 4, 28 * 4, 00 * 4);
                itemPalette[19] = Color.FromArgb(04 * 4, 32 * 4, 00 * 4);
                itemPalette[20] = Color.FromArgb(04 * 4, 40 * 4, 00 * 4);
                itemPalette[21] = Color.FromArgb(28 * 4, 58 * 4, 60 * 4);
                itemPalette[22] = Color.FromArgb(20 * 4, 44 * 4, 52 * 4);
                itemPalette[23] = Color.FromArgb(12 * 4, 28 * 4, 48 * 4);

                itemPalette[24] = Color.FromArgb(04 * 4, 12 * 4, 40 * 4);
                itemPalette[25] = Color.FromArgb(00 * 4, 00 * 4, 36 * 4);
                itemPalette[26] = Color.FromArgb(16 * 4, 16 * 4, 16 * 4);
                itemPalette[27] = Color.FromArgb(20 * 4, 20 * 4, 20 * 4);
                itemPalette[28] = Color.FromArgb(28 * 4, 28 * 4, 28 * 4);
                itemPalette[29] = Color.FromArgb(36 * 4, 36 * 4, 36 * 4);
                itemPalette[30] = Color.FromArgb(48 * 4, 48 * 4, 48 * 4);
                itemPalette[31] = Color.FromArgb(60 * 4, 60 * 4, 60 * 4);
            }
        }
        ...
        {
            byte startValue = 128;
            if (input < startValue || input > (startValue + townPalette.Length))
                return defaultPalette[input];
            else
                return townPalette[input - startValue];
        }
        static private Color getItemColor(Byte input)
        {
            ...
            if (input < startValue || input > (startValue + townPalette.Length))
                ...
                return itemPalette[input - startValue];
        }       
    }
}
